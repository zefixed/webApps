...
test_data = {
    ...
    "show_employee": [
        ...
        (["Иванов Иван Иванович", 9832450978634508796],
         "Иванов Иван Иванович: 9832450978634508796 ₽"),
    ...
    "sum_and_sub": [
        ...
        ([65789045938074378960, 9873249057843608975432], [
         9939038103781683354392, -9807460011905534596472]),
    ],
    "process_list": [
        ([1, 2], [1, 4]),
        ([0], [0]),
...
def test_my_sum_argv(input_data, expected):
    ...
    assert subprocess.check_output(
        [command, filename, *args], encoding="cp1251").strip() == expected
...
def test_files_sort(input_data, expected):
    ...
    command, filename, *args = input_data
    assert subprocess.check_output(
        [command, filename, *args], encoding="cp1251").strip().replace("\r", "") == expected
